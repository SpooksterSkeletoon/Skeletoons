            ...
            if (acc.length > 0) {
              ...
              web3.eth
                ...
                .on("receipt", async function (receipt) {
                  ...
                  let contractFunctionData2 = contractBattles.methods.goToBattle(tokenId, web3.utils.toWei(prize), web3.utils.toWei(entry)).encodeABI();
                    web3.eth
                      .sendTransaction({
                        from: acc[0],
                        to: contractIDBattles,
                      ...
                      .on("receipt", async function (receipt) {
                        ...
                        let logID = await contractBattles.methods.battleCount().call();
                        appendLog(logID);
                      })
